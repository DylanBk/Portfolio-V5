...
export default function Home() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="h-full w-fit z-10 ml-7 mt-56 sm:mt-56 md:mt-56 xl:mt-64 text-lg xs:text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold dark:text-white select-none smooth-change">
            ...
            <div className="w-fit z-10 flex flex-row gap-7 mx-auto sm:mx-0 sm:pl-7 mt-28 text-nowrap text-onyxBlack dark:text-white">
                <a
                    id="primary-cta"
                    className="w-fit flex flex-row gap-1 items-center px-4 py-3 sm:py-4 rounded-xl text-sm sm:text-lg font-bold font-fira-code"
